...
class FiletypeField extends TextField
{
    ...
    protected function getInput()
    {
        ...
        $html[] = '         <a class="btn btn-secondary filetype-edit add-on input-group-text" role="button"><i class="icon-edit icon-apply"></i><span role="none">' . Text::_('JACTION_EDIT') . '</span></a>';
        $html[] = '     </div>';
        $html[] = ' </div>';
        ...
        foreach ($data as $group => $items) {
            ...
            $html[] = '<dl class="checkboxes filetype-list" hidden>';
            ...
            if (is_string($group)) {
                ...
                $html[] = '<dt class="filetype-group" data-filetype-group="' . $group . '"><input type="checkbox" value="' . $group . '"' . $checked . ' /><label>' . $groupName . '</label></dt>';
            }
            ...
            foreach ($items as $item) {
                ...
                $html[] = '<dd class="filetype-item border bg-light-subtle"><input type="checkbox" value="' . $mod . '"' . $checked . ' /><span class="wfe-ico wfe-i-file wfe-i-file-' . $mod . '"></span><label>' . $mod . '</label>';
            ...
            $html[] = '<dd class="filetype-item filetype-custom border"><span class="wfe-ico wfe-i-file"></span><input type="text" class="form-control" value="" placeholder="' . Text::_('WF_EXTENSION_MAPPER_TYPE_NEW') . '" /><button class="btn btn-link filetype-add"><span class="icon-plus"></span></button><button class="btn btn-link filetype-remove"><span class="icon-trash"></span></button></dd>';
