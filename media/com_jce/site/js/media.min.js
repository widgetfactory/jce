...
(function ($) {
    ...
    $(document).ready(function ($) {
        ...
        $('.wf-media-input').not('.wf-media-input-active').prop('disabled', true);

        // update existing repeatable
        $('.wf-media-input').parents('.subform-repeatable-group').each(function (i, row) {
            if (!canProcessField(row)) {
                $(row).parents('joomla-field-subform').find('button.group-add, button.group-remove, button.group-move').hide();
            }
        });
        ...
        $(document).on('subform-row-add', function (evt, row) {
            ...
            if (canProcessField(row)) {
                ...
                $(row).find('.wf-media-input').each(function () {
                    $(this).prop('disabled', true).parents('joomla-field-media').addClass('wf-media-wrapper');
                });
