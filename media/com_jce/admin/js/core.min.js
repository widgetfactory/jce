(function () {
    ...
    const removeRepeatable = (e) => {
        ...
        // clear or remove
        if (parent.querySelectorAll('.form-field-repeatable-item').length === 1) {
            repeatable.querySelectorAll('input').forEach((input) => {
                input.value = '';
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // remove loader
      document.addEventListener('DOMContentLoaded', () => {
        document.querySelector('.ui-jce').classList.remove('loading');
      });
