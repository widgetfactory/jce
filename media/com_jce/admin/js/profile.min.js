(function () {
    ...
    const ucfirst$1 = (str) => str.charAt(0).toUpperCase() + str.substring(1);
    ...
    ToolbarTheme.addEventListener('change', () => {
        ...
        if (value.indexOf('.') !== -1) {
            cls = value.replace(/([^.]+)\.([\w]+)/, (match, skin, variant) => {
                const skinClass = 'mce' + ucfirst$1(skin);
                return skinClass + 'Skin ' + skinClass + 'Skin' + ucfirst$1(variant);
            });
        } else {
            cls = 'mce' + ucfirst$1(value) + 'Skin';
        }
