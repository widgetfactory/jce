...
(function () {
    ...
    var WfEditor = {
        ...
        createTabs: function (ed) {
            ...
            // get plugins list as array adding external plugins
            var pluginsArray = settings.plugins.split(',').concat(Object.keys(settings.external_plugins || {}));
            // covert to object map
            var plugins = tinymce.makeMap(pluginsArray);

            // we need at least one of these to show tabs
            if (!plugins.preview && !plugins.source) {
                return false;
            }
