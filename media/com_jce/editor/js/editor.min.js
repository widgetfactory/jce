    ...
    var JoomlaEditor = {
            ...
            if (Joomla.editors) {
                Joomla.editors.instances[editor.id] = {
                    ...
                    getSelection: function () {
                        return self.getSelection(editor.id, { format: 'text' });
                    },
                    replaceSelection: function (value) {
                        return self.insert(editor.id, value);
                    },
        ...
        unregister: function (editor) {
            ...
            if (typeof JceDecorator !== "undefined") {
                ...
                if (instance && instance instanceof JoomlaEditorDecorator) {
    ...
    var WfEditor = {
        ...
        load: function () {
            ...
            tinyMCE.onAddEditor.add(function (mgr, ed) {
                ...
                if (window.Joomla) {
                    // update editor settings object with Joomla options
                    if (Joomla.getOptions) {
                        ed.settings = extend(ed.settings, Joomla.getOptions('plg_editor_jce', {}));
                    }

                    JoomlaEditor.register(ed);
                }
