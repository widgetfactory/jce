...
(function () {
    ...
    var WfEditor = {
            ...
            tinyMCE.onAddEditor.add(function (mgr, ed) {
                ...
                if (window.Joomla) {
                    ...
                    if (Joomla.getOptions) {
                        var options = getScriptOptions('joomla_xtd_buttons', {}), btns = ed.settings.joomla_xtd_buttons || {};

                        if (options && tinymce.is(options, 'object')) {
        ...
        setActiveLine: function (ed, pos, fromCharacterIndex) {
            var blocks = [], node, doc = ed.getDoc(), body = ed.getBody();
            ...
            function getElementNodeAtCharacterIndexPosition(position) {
                ...
                let walker = doc.createTreeWalker(body, NodeFilter.SHOW_TEXT, null, false);
        ...
        textareaResize: function (el) {
            ...
            DOM.bind(el, 'mousedown', function (e) {
                ...
                var mu = DOM.bind(el, 'mouseup', function (e) {
