...
(function () {
    ...
    function getBookmarkId(ed) {
        var prefix = 'wf-bookmark-{path}{query}-{id}-';
        prefix = prefix.replace(/\{path\}/g, document.location.pathname);
        prefix = prefix.replace(/\{query\}/g, document.location.search);
        prefix = prefix.replace(/\{id\}/g, ed.id);

        // replace some characters and remove multiple - characters
        prefix = prefix.replace(/\//g, '_').replace(/-+/g, '_').replace(/_$/, '');
    ...
    var WfEditor = {
        ...
        load: function () {
            ...
            tinyMCE.onAddEditor.add(function (mgr, ed) {
                ...
                ed.onInit.add(function () {
                    ...
                    if (ed.settings.refocus) {
                        window.setTimeout(function () {
                            ...
                            var bookmark = sessionStorage.getItem(getBookmarkId(ed));
                ...
                ed.onSaveContent.add(function () {
                    ...
                    sessionStorage.setItem(getBookmarkId(ed), bookmark);
                });
        ...
        setActiveLine: function (ed, pos, fromCharacterIndex) {
            ...
            function getElementNodeAtIndexPosition(position) {                
            ...
            if (fromCharacterIndex) {
                node = getElementNodeAtIndexPosition(pos);
            } else {
