(function () {
    ...
    function TableGrid(table, dom, selection, settings) {
        ...
        function cloneCell(cell) {
            ...
            if (settings.table_clone_elements) {
                cloneFormats = ibis.makeMap((settings.table_clone_elements || 'strong em b i span font h1 h2 h3 h4 h5 h6 p div').toUpperCase(), /[ ,]/);
            }

            // Clone formats
            ibis.walk(cell, function (node) {
                var curNode;
                ...
                for (y = startY; y <= endY; y++) {
                    for (x = startX; x <= endX; x++) {
                        ...
                        if (cell != startCell) {
                            ...
                            if (children.length) {
                                children = ibis.grep(startCell.childNodes);
                                count = 0;
    ...
    * Copyright (c) 2009–2026 Ryan Demmer. All rights reserved.
    ...
    function showTableDialog(ed, isBasicDialog) {
        ...
        each$1(['void', 'above', 'below', 'hsides', 'vsides', 'box', 'border'], function (value) {
        ...
        each$1(['none', 'groups', 'rows', 'cols', 'all'], function (value) {
    ...
    function showRowDialog(ed, isBasicDialog) {
    ...
    function showCellDialog(ed, isBasicDialog) {
        ...
        ed.onInit.add(function (ed) {
            ...
            function moveWebKitSelection() {
                function eventHandler(e) {
                    ...
                    if (isVerticalMovement() && isInTable()) {
