...
(function (ibis) {
    ...
    ibis.onBeforeUnload.add(function (ibis, e) {
        var msg;

        ibis.each(ibis.editors, function (editor) {
    ...
    ibis.PluginManager.add('autosave', function (ed) {
        var self = this,
         ...
         *
         * @event onStoreDraft
         * @param {ibis.plugins.AutoSave} sender Plugin instance sending the event.
        ...
        prefix = settings.autosave_prefix || 'ibis-autosave-{path}{query}-{id}-';
        ...
        function isEmpty(html) {
            ...
            html = ibis.trim(typeof html == "undefined" ? ed.getBody().innerHTML : html);
        ...
        //window.onbeforeunload = ibis._beforeUnloadHandler;
    });
})(ibis);