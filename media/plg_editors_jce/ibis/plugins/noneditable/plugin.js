...
(function () {
  ...
  ibis.PluginManager.add('noneditable', function (editor) {
    var nonEditableRegExps, contentEditableAttrName = 'contenteditable';

    var editClass = ibis.trim(editor.getParam("noneditable_editable_class", "mceEditable"));
    var nonEditClass = ibis.trim(editor.getParam("noneditable_noneditable_class", "mceNonEditable"));
    ...
    function convertRegExpsToNonEditable(e) {
      var i = nonEditableRegExps.length, content = e.content, cls = ibis.trim(nonEditClass);
    ...
    editor.onPreInit.add(function () {
      editor.formatter.register('noneditable', {
        ...
        onformat: function (elm, fmt, vars) {
          ibis.each(vars, function (value, key) {
    ...
    /*editor.onInit.add(function () {
      ...
      editor.onNodeChange.add(function (ed, cm, n, collapsed) {
        ...
        ibis.each(cm.controls, function (c) {
          if (c && c.isRendered()) {
            c.setDisabled(state);
          }
        });
