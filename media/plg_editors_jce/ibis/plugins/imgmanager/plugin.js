 ...
 */
(function () {
    var DOM = ibis.DOM, Event = ibis.dom.Event, extend = ibis.extend;
    ...
    ibis.PluginManager.add('imgmanager', function (ed, url) {
        var self = this;
        ...
        this.getAttributes = function (data) {
            ...
            if (attribs.style && ibis.is(attribs.style, 'string')) {
                // parse to object
                attribs.style = ed.dom.parseStyle(attribs.style);
            }

            // get styles object
            if (attribs.styles && ibis.is(attribs.styles, 'object')) {
                // extend style object
            ...
            ibis.each(supported, function (key) {
                if (ibis.is(attribs[key])) {
