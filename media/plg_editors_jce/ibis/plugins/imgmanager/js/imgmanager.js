...
(function ($) {
    ...
    var ImageManagerDialog = {
        ...
        insert: function () {
            ...
            if ($('#src').val() === '') {
                Wf.Modal.alert(ibisPopup.getLang('imgmanager_dlg.no_src', 'Please enter a url for the image'));
                return false;
            }
            ...
            if ($('#alt').val() === '') {
                Wf.Modal.confirm(ibisPopup.getLang('imgmanager_dlg.missing_alt'), function (state) {
                    if (state) {
                        self.insertAndClose();
                    }
                }, {
    ...
    //ibisPopup.onInit.add(ImageManagerDialog.init, ImageManagerDialog);
