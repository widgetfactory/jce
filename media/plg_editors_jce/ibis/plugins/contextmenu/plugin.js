...
(function () {
    var Event = ibis.dom.Event,
        DOM = ibis.DOM;

    /**
     * This plugin a context menu to ibis editor instances.
     *
     * @class ibis.plugins.ContextMenu
     */
    ibis.PluginManager.add('contextmenu', function (ed) {
        var self = this,
        ...
        var isMacWebKit = function () {
            return ibis.isMac && ibis.isWebKit;
        };
         ...
         *
         * @event onContextMenu
         * @param {ibis.plugins.ContextMenu} sender Plugin instance sending the event.
         * @param {ibis.ui.DropMenu} menu Drop down menu to fill with more items if needed.
         */
        self.onContextMenu = new ibis.util.Dispatcher(this);

        // disable on Android and iOS as it prevents selection
        if (ibis.isAndroid || ibis.isIOS) {
            return false;
        }
