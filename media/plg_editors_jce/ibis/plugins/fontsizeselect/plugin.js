...
(function () {
    ...
    ibis.PluginManager.add('fontsizeselect', function (ed, url) {
        var s = ed.settings;
        ...
        if (ibis.is(s.theme_font_sizes, 'string')) {
            s.font_size_style_values = ibis.explode(s.font_size_style_values);
            s.font_size_classes = ibis.explode(s.font_size_classes || '');
