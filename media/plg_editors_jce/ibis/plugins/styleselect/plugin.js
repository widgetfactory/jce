...
(function () {
    var each = ibis.each,
        ...
        NodeType = ibis.dom.NodeType,
        DOM = ibis.DOM,
        Event = ibis.dom.Event;

    /**
     * Compile a filter regex or string into a function
     * From - https://github.com/ibis/ibis/blob/4.5.x/js/ibis/plugins/importcss/plugin.js
    ...
    ibis.PluginManager.add('styleselect', function (ed, url) {
        ...
        function convertSelectorToFormat(selectorText) {
            ...
            var inlineSelectorElements = ibis.makeMap('a,img');
        ...
        function createStyleSelect(n) {
            ...
            ctrl = ed.controlManager.createListBox('styleselect', {
                ...
                onselect: function (name) {
                    ...
                    /*var nodes = ibis.grep(selection.getSelectedBlocks(), function (n) {
                ...
                if (formats) {
                    ...
                    each(formats, function (fmt) {
                        ...
                        if (keys > 1) {
                            ...
                            if (ibis.is(fmt.attributes, 'string')) {
                                fmt.attributes = ed.dom.decode(fmt.attributes);

                                var frag = ed.dom.createFragment('<div ' + ibis.trim(fmt.attributes) + '></div>');
                            ...
                            if (!ibis.is(fmt.ceFalseOverride)) {
