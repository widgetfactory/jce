(function () {
     ...
     * @param {Object} ed      The ibis editor instance
     * @returns {Object}
     */
     ...
     *
     * @class ibis.ui.MeasurementBox
     * @extends ibis.ui.Control
     */
    ibis.create('ibis.ui.MeasurementBox:ibis.ui.Control', {
     ...
     */
    ibis.ControlManager.prototype.createMeasurementBox = function (id, s) {
        ...
        c = new ibis.ui.MeasurementBox(id, s, ed);
        return self.add(c);
    };
