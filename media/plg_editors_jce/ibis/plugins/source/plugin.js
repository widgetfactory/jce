...
(function () {
    ...
    ibis.PluginManager.add('source', function (ed, url) {
        var self = this;
        ...
        this.ControlManager = new ibis.ControlManager(ed);
        ...
        this.save = function (content, debounced) {
            ...
            content = ibis.is(content) ? content : this.getContent();
        ...
        this.toggle = function () {
            ...
            var o = ibis.util.Storage.getHash("ibis_" + ed.id + "_size");
            ...
            var content = ibis.is(element.value) ? element.value : element.innerHTML;
