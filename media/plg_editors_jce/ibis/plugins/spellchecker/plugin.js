...
(function () {
    ...
    ibis.PluginManager.add('spellchecker', function (ed, url) {
        var self = this;
        ...
        this.setLanguage = function (lang) {
            ...
            if (ibis.grep(self.languages, function (v) {
                return v === lang;
            }).length === 0) {
        ...
        function showMenu(ed, e) {
            ...
            if (dom.hasClass(wordSpan, 'mce-item-hiddenspellword')) {
                ...
                return ibis.dom.Event.cancel(e);
            } else {
                m.hideMenu();
            }
        }
