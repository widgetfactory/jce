    ...
    var ibis = {
        ...
        documentBaseURI: {
            toAbsolute: function (url) {
                ...
                var root = ibis.settings.document_base_url;
            ...
            toRelative: function (url) {
                if (/:\/\//.test(url)) {
                    var base = ibis.settings.document_base_url;
        ...
        windowManager: {
            params: {
                ...
                callback: function (selected, data) {
                    ...
                    var elm = win.document.getElementById(ibis.settings.element);
            ...
            open: function (args, params) {
                args.url += '&' + ibis.settings.token + '=1&standalone=1';
                ...
                // Store params
                ibis.windowManager.params = params;
            },
