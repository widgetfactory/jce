...
var tinymce = {
    ...
    documentBaseURI: {
        toAbsolute: function(url) {
            ...
            var root = tinyMCEPopup.editor.settings.document_base_url;
        ...
        toRelative: function(url) {
            if (/:\/\//.test(url)) {
                var base = tinyMCEPopup.editor.settings.document_base_url;
    ...
    windowManager: {
        params: {
            ...
            callback: function (selected, data) {
                ...
                var elm = win.document.getElementById(settings.element);
        ...
        open: function (args, params) {
            ...
            args.url += '&' + settings.token + '=1';

            if (settings.context) {
                args.url += '&context=' + settings.context;
            }
