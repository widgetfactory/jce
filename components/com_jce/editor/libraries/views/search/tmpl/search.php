...
<div id="search-browser" class="uk-width-1-1">
    <div class="uk-grid uk-grid-collapse">
        <div id="searchbox" class="uk-form-icon uk-form-icon-flip uk-width-4-5">
        ...
        <div class="uk-button-group uk-width-1-5 uk-flex">
            <button class="uk-button uk-width-3-4" id="search-button"><label class="uk-form-label"><?php echo Text::_('WF_LABEL_SEARCH'); ?></label></button>
            <button class="uk-button uk-width-1-4" id="search-options-button" title="<?php echo Text::_('WF_LABEL_SEARCH_OPTIONS'); ?>" aria-label="<?php echo Text::_('WF_LABEL_SEARCH_OPTIONS'); ?>" aria-haspopup="true"><i class="uk-icon uk-icon-cog"></i></button>
        </div>
    </div>
    ...
    <div id="search-options" class="uk-dropdown uk-width-1-1">
        ...
        <fieldset class="search_only">
            ...
            <ul>
            <?php foreach ($this->searchareas as $val => $txt): ?>
                <li>
