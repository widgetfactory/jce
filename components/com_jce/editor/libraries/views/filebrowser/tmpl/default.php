...
?>
<form class="uk-form uk-form-horizontal" onsubmit="return false;" action="<?php echo $this->action; ?>" target="_self"
    ...
    <div id="browser">
        ...
        <main class="uk-grid uk-grid-collapse uk-width-1-1 uk-position-cover uk-flex">
            <div class="uk-width-3-10">
                <div class="uk-navbar">
                    <div class="uk-navbar-content uk-navbar-center"><?php echo WFText::_('WF_LABEL_FOLDERS'); ?></div>
                </div>
                <div id="browser-tree">
                    <div id="tree-body" class="tree"></div>
                </div>
            </div>
            <div class="uk-flex-item-auto uk-position-relative">
                <div class="uk-navbar">
                    <div class="uk-navbar-content uk-width-1-1 uk-grid uk-grid-collapse uk-flex uk-padding-remove uk-position-relative" id="browser-list-actions">
                            ...
                            <!-- Sort Date -->
                            <div class="uk-width-2-10 uk-button uk-padding-remove uk-text-left" id="sort-date" role="button" data-sort-type="date" aria-labelledby="sort-date-label"
                                 aria-hidden="true">
                            ...
                            <!-- Sort Size -->
                            <div class="uk-width-3-10 uk-button uk-padding-remove uk-text-left" id="sort-size" role="button" data-sort-type="number" aria-labelledby="sort-size-label"
                                 aria-hidden="true">
                                <i class="uk-icon-sort-numeric-asc"></i>
                                <i class="uk-icon-sort-numeric-desc"></i>
                ...
                <div id="browser-list-limit" class="uk-navbar">
                    <div class="uk-width-1-1 uk-grid uk-grid-collapse">
                        <ul class="limit-left uk-pagination uk-pagination-left uk-width-1-4">
                            <li class="limit-left-end uk-hidden" role="button">
                              <a href=""><i class="uk-icon-fast-backward"></i></a>
                            </li>
                            <li class="limit-left uk-hidden" role="button">
                        ...
                        <div class="limit-text uk-navbar-content uk-width-2-4">
                            <label for="browser-list-limit-select"
                                   class="uk-margin-small-right"><?php echo WFText::_('WF_LABEL_SHOW'); ?></label>
                        ...
                        <ul class="limit-right uk-pagination uk-pagination-right uk-width-1-4">
                            <li class="limit-right uk-hidden" role="button">
                                <a href=""><i class="uk-icon-forward"></i></a>
                            </li>
                            <li class="limit-right-end uk-hidden" role="button">
            ...
            <div class="uk-width-3-10 uk-position-relative">
                <div class="uk-navbar">
                    <div class="uk-navbar-content uk-navbar-center"><?php echo WFText::_('WF_LABEL_DETAILS'); ?></div>
                </div>
