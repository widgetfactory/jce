...
(function($) {
	...
	ColorPicker.prototype = {
				...
				$(this.widget).css('background-color', $(this.element).val() || '#000000').tips({
					...
					$('#colorpicker').append(
						...
						'<div id="colorpicker_preview">' +
					      ...
					      '</div>' +
					  '</div>' +
						'<button type="button" class="btn btn-primary ui-button ui-button-primary" id="colorpicker_insert"><i class="ui-icon-check" />' + self._translate('apply', 'Apply') + '</button>' +
						'</div>'
					);
		...
		_getContent: function() {
			...
			h += '<div id="colorpicker_tabs" class="ui-tabs">';
			h += '<ul class="nav nav-tabs ui-tab">';
			...
			h += '</ul>';
			h += '<div class="tab-content ui-switcher ui-tabs-panel">';
			h += '<div id="colorpicker_picker" data-type="picker" class="tab-pane ui-active"></div>';
