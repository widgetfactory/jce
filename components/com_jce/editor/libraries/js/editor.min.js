    ...
    var WFEditor = {
        ...
        init: function (settings) {
            ...
            tinymce.extend(tinymce, {
                ...
                suffix: '',
                query: settings.token + '=1&context=' + settings.context + '&' + settings.etag
            });
        ...
        _markLoaded: function () {
            ...
            /*each(['core', 'help', 'autolink', 'cleanup', 'code', 'format', 'importcss', 'colorpicker', 'upload', 'figure', 'ui', 'noneditable', 'formatselect', 'styleselect', 'cleanup', 'fontselect', 'fontsizeselect', 'fontcolor', 'clipboard', 'lists', 'advlist', 'textcase', 'charmap', 'hr', 'directionality', 'fullscreen', 'print', 'searchreplace', 'table', 'style', 'xhtmlxtras', 'visualchars', 'visualblocks', 'nonbreaking', 'anchor', 'link', 'imgmanager', 'spellchecker', 'article', 'spellchecker', 'article', 'browser', 'contextmenu', 'inlinepopups', 'media', 'preview', 'source', 'wordcount'], function (n) {
                load('plugins/' + n + '/editor_plugin' + suffix + '.js');
            });*/
        },
        ...
        load: function () {
            ...
            Event.bind(window, 'load', function () {
                ...
                if (window.jQuery) {
                    ...
                    jQuery(document).on('subform-row-sort', function (e, row) {
                        var elements = DOM.select('.wf-editor', row);
        ...
        getActiveLine: function (ed) {
            ...
            // get number of lines
            var node = ed.selection.getNode(), nodes = ed.getBody().querySelectorAll(blocks.join(','));
