...
(function () {
    ...
    var WfEditor = {
        ...
        createInstance: function (el) {
            ...
            // get toggle option
            var toggle = tinymce.is(s.toggle) ? parseInt(s.toggle, 10) : 1;
        ...
        createTabs: function (ed) {
            ...
            // Editor tab
            var editorTab = DOM.add(ul, 'li', { 'role': 'presentation' }, '<a role="presentation"><button type="button" aria-controls="wf-editor-wysiwyg" aria-expaned="false" role="tab">' + ed.getLang('tab.wysiwyg', 'Editor') + '</button></a>');

            // Source tab
            if (tinymce.inArray(plugins, 'source') !== -1) {
                var sourceTab = DOM.add(ul, 'li', { 'role': 'presentation' }, '<a role="presentation"><button type="button" aria-controls="wf-editor-source" aria-expaned="false" role="tab">' + ed.getLang('tab.code', 'Code') + '</button></a>');
            ...
            if (tinymce.inArray(plugins, 'preview') !== -1) {
                var previewTab = DOM.add(ul, 'li', { 'role': 'presentation' }, '<a role="presentation"><button type="button" aria-controls="wf-editor-preview" aria-expaned="false" role="tab">' + ed.getLang('tab.preview', 'Preview') + '</button></a>');
            ...
            Event.add(ul, 'click', function (e) {
                ...
                var item = DOM.getParent(e.target, 'li');
