    ...
    var WFEditor = {
        ...
        init: function (settings) {
            ...
            tinymce.extend(tinymce, {
                ...
                suffix: '',
                query: settings.token + '=1&context=' + settings.context
            });
        ...
        _markLoaded: function () {
            ...
            /*each(['core', 'autolink', 'cleanup', 'code', 'format', 'importcss', 'colorpicker', 'upload', 'figure', 'ui', 'noneditable'], function(n) {
                load('plugins/' + n + '/editor_plugin' + suffix + '.js');
            });*/
        },
        ...
        getActiveLine: function (ed) {
            ...
            if (node.getAttribute('data-mce-type') === "bookmark") {
