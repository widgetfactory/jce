...
(function () {
    ...
    var WfEditor = {
        ...
        createTabs: function (ed) {
            ...
            // Editor tab
            var editorTab = DOM.add(tablist, 'button', { 'type' : 'button', 'class': 'nav-item', 'role': 'tab', 'aria-controls' : 'wf-editor-wysiwyg' }, ed.getLang('tab.wysiwyg', 'Editor'));
            ...
            if (tinymce.inArray(plugins, 'source') !== -1) {
                var sourceTab = DOM.add(tablist, 'button', { 'type' : 'button', 'class': 'nav-item', 'role': 'tab', 'aria-controls' : 'wf-editor-source' }, ed.getLang('tab.code', 'Code'));
            ...
            if (tinymce.inArray(plugins, 'preview') !== -1) {
                var previewTab = DOM.add(tablist, 'button', { 'type' : 'button', 'class': 'nav-item', 'role': 'tab', 'aria-controls' : 'wf-editor-preview' }, ed.getLang('tab.preview', 'Preview'));
            ...
            if (!state && toggle) {
                DOM.hide(DOM.select('.nav-tabs', el.parentNode));
            }
        },
