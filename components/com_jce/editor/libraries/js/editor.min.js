    ...
    var WFEditor = {
        ...
        init: function (settings) {
            ...
            if (this.settings) {
                try {
                    ...
                    // pass settings to Joomla config...
        ...
        create: function (elements) {
            ...
            if (elements) {
                ...
                if (tinymce.is(elements, 'array')) {
                    s.elements = elements.join(',');
                }

                // id
                if (tinymce.is(elements, 'string')) {
                    s.elements = elements;
                    // get element from id
