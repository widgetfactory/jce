...
?>
  ...
  <div class="uk-form-row">
    ...
    <div class="uk-width-6-10">
      ...
      <label for="youtube_modestbranding" title="<?php echo WFText::_('WF_AGGREGATOR_YOUTUBE_MODESTBRANDING_DESC') ?>" class="tooltip">
  ...
  <div class="uk-form-row">
        <label for="youtube_params" class="uk-form-label uk-width-1-5 hastip" title="<?php echo WFText::_('WF_AGGREGATOR_YOUTUBE_PARAMS_DESC'); ?>"><?php echo WFText::_('WF_AGGREGATOR_YOUTUBE_PARAMS'); ?></label>
