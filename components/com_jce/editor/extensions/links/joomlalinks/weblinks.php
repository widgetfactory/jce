...
class JoomlalinksWeblinks extends JObject {
    ...
    public function getList() {
        ...
        if ($wf->checkAccess('links.joomlalinks.weblinks', 1)) {
            return '<li id="index.php?option=com_weblinks&view=categories"><div class="ui-tree-row"><a href="#"><span class="ui-tree-icon folder weblink nolink"></span><span class="ui-tree-text">' . WFText::_('WF_LINKS_JOOMLALINKS_WEBLINKS') . '</span></a></div></li>';
        }
    }
