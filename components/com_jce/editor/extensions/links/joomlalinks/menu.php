...
class JoomlalinksMenu extends JObject {
    ...
    public function getList() {
        ...
        if ($wf->checkAccess('links.joomlalinks.menu', 1)) {
            return '<li id="index.php?option=com_menu"><div class="ui-tree-row"><a href="#"><span class="ui-tree-icon folder menu nolink"></span><span class="ui-tree-text">' . WFText::_('WF_LINKS_JOOMLALINKS_MENU') . '</span></a></div></li>';
        }
    }
