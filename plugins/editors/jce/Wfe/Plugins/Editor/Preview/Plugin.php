 ...
 */
namespace Wfe\Plugins\Editor\Preview;
...
class Plugin extends \Wfe\Editor\Plugin\AbstractPlugin
{
    ...
    public function showPreview()
    {
        ...
        if ((bool) $this->getParam('process_content', 1)) {
            ...
            $article->text = \Joomla\CMS\HTML\Helpers\Content::prepare($article->text, $params, $context);
        }
        ...
        $event = new Event('onWfContentPreview', array(
            'context' => $context,
            'article' => $article,
            'params' => $params,
            'page' => $page,
        ...
        $app->getDispatcher()->dispatch('onWfContentPreview', $event);
